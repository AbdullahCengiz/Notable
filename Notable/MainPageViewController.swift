...
class MainPageViewController: UIViewController,UITableViewDelegate ,UITableViewDataSource {
    ...
    func setUpPoints(){
        ...
        var point1 = Point(userName: "Alexander", point: "110p", madelsImage: "goldmedal")
        var point2 = Point(userName: "Alexander", point: "120p", madelsImage: "goldmedal")
        var point3 = Point(userName: "Alexander", point: "130p", madelsImage: "goldmedal")
        var point4 = Point(userName: "Alexander", point: "140p", madelsImage: "goldmedal")
        var point5 = Point(userName: "Alexander", point: "150p", madelsImage: "goldmedal")
