...
{
    for (int n = 0; n < 128; ++n)
        _pitches[n] = 440.0f * powf(2, (n - 69)/12.0f);  // A4 = MIDI key 69 CDEFGAH 012345 A4 = 69

    // A3=62. H3=63. C4=64. D4=65. E4=66. F4=67. G4=68. A4=69. H4=70. C5=71
    /*C-1
     D-2
     E-3
     F4
